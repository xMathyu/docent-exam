...
export const questionsVersion1: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Preguntar a los niños: “¿Por qué dejan el caño abierto?”. Luego, proponerles queelaboren carteles con la imagen de un caño cerrado y el mensaje: “Cierra el cañodespués de usarlo”, para que no se olviden de hacerlo. Finalmente, pegar conjuntamente con los niños los carteles en los lavaderos.'
    ],
    correctAnswer: 'a'
  },
  {
  ...
  },
  {
    id: 19,
    question:
      'La docente del aula de cinco años tiene el propósito de que sus niños resuelvan problemas, ¿Cuál de las siguientes acciones contribuiría a dicho propósito?',
    options: [
  ...
  },
  {
    id: 27,
    question:
      'Para ayudar a los niños a entender la relación entre los objetos y su entorno, la docente organiza una actividad en el aula. ¿Cuál es la mejor opción?',
    options: [
      'Pedir a los niños que describan verbalmente la ubicación de varios objetos en elaula',
      'Realizar un juego en el que los niños deban colocar objetos en lugares específicos siguiendo instrucciones como "encima de la mesa" o "debajo de la silla".',
      'Mostrar imágenes de diferentes habitaciones y pedir a los niños que identifiquen los objetos en cada una.'
    ],
    correctAnswer: 'b'
  },
  {
    ...
    options: [
      ...
      'Que la niña no inició el proceso de la adquisición de la noción de número.'
    ],
    correctAnswer: 'b'
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      'Permite que los niños se concentren en la actividad al trabajar en un espacio delimitado.'
    ],
    correctAnswer: 'b'
  },
  {
    id: 31,
    question:
      'Elisa y Marcos, de cinco años, juegan a las carreras en el patio. Ambos corren hacia el árbol, Elisa llega primero y exclama: “Yeeee, yo llegué primero, tú segundo”.\n\n¿Qué uso del número se evidencia en la intervención de Elisa?',
    options: ['Como nominal.', 'Como cardinal.', 'Como ordinal.'],
    correctAnswer: 'c'
  },
  {
    id: 32,
    ...
    options: [
      'Decir al niño: “¿Y qué hizo tu mamá? Y ¿qué dijo tu papá?”.',
      'Decir al niño: “A ver César, no mañana sino ayer, ayer fui donde mis abuelos".',
      'Decir al niño: “Cuéntame más de lo te pasó ayer cuando visitaste a tus abuelitos”.'
    ],
    correctAnswer: 'b'
  },
  {
    id: 33,
    question:
      'La docente y los niños del aula de cinco años visitan la casa de Víctor, un compañero del aula cuya familia cría animales de corral, como patos, gallinas y pollitos. La mayoría de los niños ya ha visto antes este tipo de animales. Durante la visita, el grupo observa distintas huellas. Señalando una de ellas, Juan dice: “¡Miren esas huellas!, ¿adivinen de qué animal es?”.\n\n¿Qué nivel de representación de la función simbólica se evidencia en la intervención de Juan?',
    options: ['Objeto.', 'Indicio.', 'Símbolo.'],
    correctAnswer: 'b'
  },
  {
    id: 34,
    question:
      '¿Cuál de las siguientes preguntas es pertinente para que los niños identifiquen información explícita en este texto?',
    options: [
  ...
  },
  {
    id: 36,
    question:
      '¿Cuál de las siguientes preguntas es pertinente para que los niños reflexionen sobre el texto?',
    options: [
      '¿Qué piensan de lo que hacía Frederick en el cuento?',
      '¿Por qué los ratoncitos aplaudieron a Frederick al final?',
      '¿Qué recogieron los ratoncitos cuando notaron que el invierno estaba cerca?'
    ],
    correctAnswer: 'a'
  },
  {
    id: 37,
    question:
      '¿Cuál de las siguientes acciones favorece la apropiación del sistema de escritura en los niños?',
    options: [
      'Presentarles en un papelógrafo el texto de una canción breve. Luego de leerles el texto, señalar algunas palabras para que las adivinen. Finalmente, entregarles hojas con el texto de la canción para que repasen las palabras con plumón.',
      'Presentarles una lista de los libros de la biblioteca del aula. Luego de leerles la lista, decirles que, cada vez que tomen un libro prestado, escriban su nombre en la lista, al costado del nombre del libro correspondiente.',
      'Presentarles una lista con los ingredientes para preparar una ensalada de frutas. Luego de leerles la lista, decirles que la transcriban a sus cuadernos e indicarles qué fruta le toca traer a cada uno.'
    ],
    correctAnswer: 'b'
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      'Pedir a los niños que observen la imagen. Luego, preguntarles quiénes serán los personajes, en qué lugar estarán, qué creen que está sucediendo, qué habrá pasado antes y cómo quisieran que termine la historia. Finalmente, pedirles que cuenten la historia completa.'
    ],
    correctAnswer: 'c'
  },
  {
    id: 42,
    question:
      '¿Cuál de las siguientes preguntas es pertinente para que los niños realicen inferencias?',
    options: [
      '¿Conocen al oso de anteojos? ¿Cuántas patas tiene?',
      '¿Qué querrá decir que el oso de anteojos está en “peligro de extinción”?',
      '¿Te gusta el oso de anteojos? ¿Qué es lo que más te gusta de él?'
    ],
    correctAnswer: 'b'
  },
  {
    id: 43,
    question:
      'La docente del aula de cinco años busca favorecer el acercamiento de los niños a la lectura. Para ello, ha colocado en el respaldo de las sillas tarjetas con sus respectivos nombres y ha cambiado las sillas de lugar antes de que ellos ingresen al aula. Cuando los niños ingresan, la docente les propone que encuentren sus sillas guiándose de las tarjetas que observan en ellas. Entonces, Daniela y Damaris se acercan al mismo tiempo a la silla de Damaris. Este es el diálogo que surge a continuación:\n\nDaniela: ¡Ah! ¡Ya encontré mi silla!\nDamaris: ¡No, ya! ¡Esta silla es mía! Mira, ¡aquí dice “Damaris”!\nDaniela: ¡No, es mi silla! ¡Aquí dice “Daniela”!\nDamaris: ¡Lee bien! ¡Aquí dice “DA-MA-RIS”! (la niña lee su nombre mientras señala el escrito).\n\nDaniela mira desconcertada a la docente. Ante esta situación, ¿cuál de las siguientes acciones es más pertinente para favorecer el acercamiento de Daniela a la lectura?',
    options: [
      'Preguntar a Daniela: “¿Todavía no sabes reconocer tu nombre? ¿Te gustaría que te enseñe a reconocerlo?”. Luego, llevarla hacia su silla, señalar la tarjeta y decirle: “Mira, aquí dice Daniela. Ahora ya puedes sentarte en tu silla”.',
      'Preguntar a Daniela: “¿Hay alguna marca que te permita reconocer tu silla? ¿Qué te parece si te doy un sticker para que lo pegues en ella cuando la encuentres?”. Luego, pedir a los niños que ayuden a Daniela a encontrar su silla.',
      'Preguntar a Daniela: “¿Por qué crees que ahí está escrito tu nombre? ¿Te parece si buscamos tu nombre en el cartel de asistencia?”. Después de hacerlo, añadir: “Ahora vamos a la silla en la que está Damaris. ¿Ahí dice tu nombre? ¿En qué se parece a tu nombre? ¿En qué se diferencia?”.'
    ],
    correctAnswer: 'c'
  },
  {
    id: 44,
    question:
      'Los niños y la docente del aula de cinco años salieron a un parque. De regreso al aula, ella les pide que dibujen lo que hicieron durante dicha salida y, cuando terminan de elaborar sus dibujos, conversan sobre estos. Durante la conversación, la docente busca promover en los niños la reflexión crítica. ¿Qué intervención es pertinente para ese propósito?',
    options: [
      '“Roxana, ¡qué bueno que hayas dibujado muchas cosas! Cuéntanos, ¿qué cosas has dibujado de nuestra salida al parque?”.',
      '“Saúl, veo que usaste en tu dibujo el rojo, amarillo y anaranjado. ¿Por qué elegiste esos colores para pintar?”.',
      '“Andrea, después de lo que Juanito nos ha contado sobre lo que dibujó, ¿qué título le pondrías a su dibujo?”.'
    ],
    correctAnswer: 'b'
  },
  {
  ...
  },
  {
    id: 47,
    question:
      'Los niños del aula de cinco años trajeron de sus casas geranios y chavelitas para sembrarlasen la jardinera del aula, y quieren saber qué hacer para que estas plantas crezcan fuertes y sanas. Por ello, han acordado visitar un vivero ubicado cerca de la IE para entrevistar a los encargados. ¿Cuál de las siguientes acciones es pertinente para ayudar a los niños a organizar sus ideas para la realización de la entrevista?',
    options: [
      'Pedir a los niños que, en parejas, propongan una pregunta que quisieran realizar a los encargados del vivero. Luego, elegir por votación qué preguntas formularán primero y cuáles después. ',
  ...
  },
  {
    id: 49,
    question:
      'Durante Al levantar unas piedras, Pedro, Margarita y Santiago encuentran unas tijeretas. Los niños llaman a la docente para mostrarle su hallazgo y ella les dice: “Muy bien, ¡encontraron tijeretas!”. Luego, Santiago le comenta: “Señorita, las tijeretas salieron corriendo cuando sacamos las piedras”.Ante esta situación, la docente busca que los niños formulen hipótesis respecto del comportamiento de las tijeretas. ¿Cuál de las siguientes preguntas NO es pertinente para ese propósito?',
    options: [
      '¿Por qué creen que las tijeretas se escondieron apenas sacaron las piedras?',
  ...
  },
  {
    id: 51,
    question:
      'Los niños del aula de cuatro años están escarbando la tierra y, al hacerlo, encuentran algunas lombrices. Al principio, las observan y conversan sobre ellas. Después de un rato, la docente nota que los niños están jugando a que las lombrices conversan, inventando diálogos entre ellas.\n\nEn esa situación, ¿cuál de las siguientes acciones es más pertinente que realice la docente para continuar favoreciendo la expresión oral de los niños?',
    options: [
  ...
  },
  {
    id: 53,
    question:
      'La docente y los niños del aula de cinco años han sembrado rabanitos. Luego, acuerdan qué días saldrán a observar y regar los rabanitos, todos juntos. En el marco de la iniciación a la indagación científica, ¿cuál de las siguientes acciones es más pertinente que realice la docente para promover en los niños el registro de información?',
    options: [
      'Luego de cada salida, preguntar a los niños sobre el riego realizado, la aparición de los brotes en las plantas y los cambios en su crecimiento. Después, anotar sus respuestas en un papelógrafo y leerles las anotaciones al término de cada semana.',
      'Durante cada salida, pedir a los niños que observen los cambios que puedan presentar las plantas. Al retornar al aula, pedirles que dibujen o escriban sobre lo observado y, al término de la semana, conversar con ellos sobre el crecimiento de las plantas a partir de sus dibujos y escritos.',
      'Antes de iniciar las salidas, entregar a los niños una lista de cotejo que contenga imágenes sobre cada etapa del crecimiento de las plantas de rabanitos. Luego de cada salida, pedirles que marquen la imagen que corresponda a lo observado y hacerles notar que cambios se produjeron en las plantas.'
    ],
    correctAnswer: 'b'
  },
  {
    id: 54,
    question:
      'En el aula de niños de cinco años, la docente decide realizar una actividad para explorar cómo diferentes alimentos se comportan cuando se exponen al calor. Ella presenta a los niños tres tipos de alimentos: un trozo de chocolate, un trozo de pan y una rodaja de manzana. Antes de comenzar el experimento, la maestra les pregunta a los niños: ¿Qué creen que sucederá si colocamos cada uno de estos alimentos en un lugar caliente, como junto a una lámpara?. Ante esta pregunta, algunos niños piensan que todos los alimentos se derretirán o se cocinarán porque saben que el calor puede hacer que los alimentos cambien de forma o textura; otros piensan que no pasará nada porque una lámpara no calienta mucho como la cocina que usa su mamá. Luego de realizar el experimento, notan algunos cambios en todos los alimentos, lo que les genera curiosidad por averiguar qué sucedió.\n\n¿Cuál es el propósito de la docente al proponer este experimento?',
    options: [
      'Promover el recojo de saberes previos.',
  ...
  },
  {
    id: 55,
    question:
      'En el aula de cinco años, durante la actividad "Cocinamos juntos", los niños han aprendido a preparar una receta de galletas. Han medido los ingredientes, mezclado y horneado. Al día siguiente, la docente introduce una nueva actividad: "Hagamos plastilina casera". La docente les da los ingredientes necesarios: harina, sal, agua y colorante. Antes de comenzarse produce el siguiente diálogo:\n\nDocente dice: “¿Recuerdan cómo medimos y mezclamos los ingredientes para hacer galletas?”.\nNiños dicen: “Sí”.\nDocente dice: “Muy bien, ahora usaremos esas mismas habilidades para medir y mezclar estos ingredientes para hacer plastilina. ¿Quién quiere empezar a medir la harina?”.\nPablo dice: “Yo sé medir, usamos la taza medidora como ayer”.\nAlicia dice: “Y mezclamos con la cuchara grande, como cuando hicimos las galletas”.\nDocente dice: “¡Exactamente! Vamos a hacerlo así”.\n\nLos niños proceden a medir y mezclar los ingredientes para hacer plastilina, aplicando las habilidades que aprendieron al hacer las galletas el día anterior.\n\nEn la situación planteada, ¿Qué está promoviendo principalmente la docente?',
    options: [
  ...
  },
  {
    id: 56,
    question:
      'Esteban, de cinco años, ha sido trasladado a una nueva IE. Él se desplaza en silla de ruedas. Considerando sus características, la docente se propone sensibilizar a los niños antes de su llegada al aula. Para ello, dialoga con ellos sobre cómo interactuar con Esteban en las diferentes actividades de la jornada diaria, como por ejemplo, la hora de juego al aire libre. Sobre la base del enfoque inclusivo del Currículo Nacional de la Educación Básica, ¿cuál de los siguientes comentarios de la docente es pertinente para favorecer la participación de Esteban durante el juego al aire libre?',
    options: [
      '“Como Esteban se desplaza en una silla de ruedas, hay que pensar en juegos fáciles donde él pueda participar durante el juego al aire libre”.',
      '“Debemos preguntarle a Esteban si le gustaría participar durante el juego al aire libre y de qué forma podría hacerlo”.',
      '“Para evitar que Esteban sufra algún tipo de accidente, ¿qué les parece si hacemos turnos para acompañarlo durante el juego al aire libre?”.'
    ],
    correctAnswer: 'b'
  },
  {
    id: 57,
    question:
      'Los niños y la docente del aula de cinco años van a elegir a un representante del aula para que asista a una reunión con la directora de la IE. Luego de dialogar sobre quién podría representarlos, los niños proponen a Violeta y a Darío como candidatos, y se realiza la votación levantando la mano. La docente cuenta los votos, escribe en la pizarra el resultado y dice: “Violeta: 8 votos, y Darío: 6 votos”.\n\nA continuación, la docente pregunta: “¿Quién obtuvo más votos?”, César se apresura a responder y dice: “¡Darío!”, a lo que la docente pregunta: “A ver, César, ¿cómo sabes que 6 es más que 8?”. César comienza a contar con los dedos de su mano y no logra hacer la comparación. Al verlo, la docente le propone: “¿Qué te parece si comparamos los votos de tus compañeros usando tapitas? (César coge un puñado de tapitas). Ahora, coloca 6 tapitas, que son los votos de Darío, una tapita al lado de otra, y debajo de cada tapita, coloca una por una, las 8 tapitas de los votos de Violeta”. Hecho esto, la docente le dice a César: “Ahora, dime dónde hay más, ¿en los 6 votos de Darío o en los 8 votos de Violeta?”.\n\nEn la situación presentada, ¿cuál de las siguientes acciones pedagógicas está realizando principalmente la docente en su intervención con César?',
    options: [
  ...
  },
  {
    id: 58,
    question:
      'Manuel, de cinco años, se propuso elaborar con cajas de cartón un carro con una puerta que se pueda abrir y cerrar. Una vez avanzada la elaboración del carro, la docente se da cuenta de que la manera en que Manuel está elaborando la puerta dificulta que la misma se abra y se cierre.\n\n¿Cuál de las siguientes intervenciones es pertinente para promover que Manuel reflexione sobre la elaboración de la puerta del carro?',
    options: [
      'Como el espacio que has dejado para la puerta es pequeño, ¿Qué tal si mejor haces la puerta al otro lado del carro?',
      '¿Qué te parece si intentas abrir la puerta? ¿Por qué crees que no se abre? ¿Qué te faltó hacer? ¿Cómo la podrías mejorar?',
      'Veo que no se puede abrir la puerta, ¿qué te parece si haces una puerta de cartulina, la engomas por un borde y la pegas sobre la puerta que intentaste hacer?'
    ],
    correctAnswer: 'b'
  },
  {
    id: 59,
    question:
      'Es lunes y todos los niños de la IE se forman en el patio para cantar el Himno Nacional. La docente del aula de cinco años pide a los 9 niños del aula que se ordenen del más bajo al más alto. Los niños comienzan a medirse uno a uno y les resulta difícil encontrar cómo ordenarse, aunque finalmente lo logran. Una vez que lograron ordenarse por tamaño la docente los felicita diciendo: "¡Felicitaciones, lo lograron!". Si a continuación tiene la intención de promover la metacognición en los niños sobre la acción realizada, ¿cuál de las siguientes preguntas contribuye con dicho propósito?',
    options: [
      '¿Quién es el más alto y quién es el más bajo?',
      '¿Cómo hicieron para lograr ordenarse por tamaño?',
      '¿Tendrían que cambiarse de lugar para ordenarse si sale uno de los niños del medio de la fila?'
    ],
    correctAnswer: 'b'
  },
  {
    id: 60,
    question:
      'La docente del aula de cinco años coloca una cantidad de muñequitos sobre cada una de las mesas y plantea a los niños que cada uno forme un grupo de muñequitos. Luego de que los niños lo hacen, se acerca a cada mesa y dialoga con ellos. Este es el diálogo que se produce:\n\nDocente dice: “A ver, niños, todos observen el grupo que han formado, y me dicen cuántos muñequitos tiene cada uno”.\n(Los niños cuentan el grupo que formaron y le dicen a la docente el número de muñequitos que agruparon).\n“Ahora que me dijeron la cantidad que tiene cada uno, ¿quién tiene más muñequitos?”.\nAlex dice: “Yo tengo más muñequitos, tengo 4”.\nClaudia dice: “Sí, Alex tiene más”.\nDocente dice: “A ver, Claudia, ¿por qué dices que Alex tiene más muñequitos?”.\nClaudia dice: “Porque yo solo tengo 3”.\nDocente dice: “Y, ¿cuántos muñequitos te falta para tener la misma cantidad que Alex?”.\nClaudia dice: “Me falta 1”.\nJosé dice: “A mí también me falta 1, yo tengo 3, como Claudia”.\nDocente dice: “Ahora, me pueden decir, ¿quiénes tienen menos muñequitos?”.\n(Los niños miran sus agrupaciones y las de sus compañeros).\nJosé dice: “Miriam tiene más poquito, solo tiene 2”.\nDocente dice: “¿Qué pasaría si Alex, que tiene 4, le da un muñequito a Miriam?”.\nMiriam dice: “Tendría 3”.\nAlex dice: “Sí, tendría 3, todos tendríamos 3 muñequitos. Toma, Miriam te doy 1”.\nMiriam dice: “Gracias, Alex. ¡Yeee! ¡Yo también tengo 3!”.\n\nEn el marco de la construcción de la noción de número, ¿qué proceso está desarrollando principalmente la docente en esta intervención?',
    options: [
      'Recoger saberes previos.',
      'Promover la metacognición.',
      'Brindar andamiaje.'
